...
RESCUE_SCREEN_DEPENDENCIES = stb taq102-fonts libdrm

define RESCUE_SCREEN_BUILD_CMDS
	$(TARGET_CC) $(TARGET_CFLAGS) -Wall -Wextra -Werror -I$(STAGING_DIR)/usr/include -O2 -o $(@D)/rescue-screen $(@D)/rescue-screen.c $(@D)/rescue_paint.c \
